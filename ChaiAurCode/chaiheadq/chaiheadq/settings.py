...
SECRET_KEY = 'django-insecure-o$$9*a$vr7^jvm^ax2juo#3p3u!%^zq64*-orld0vhu$=%1r%6'
...
LOGIN_URL = '/account/login'  # URL to redirect to for login

LOGIN_REDIRECT_URL = '/tweet/'  # Redirect to tweet list after login
LOGOUT_REDIRECT_URL = '/tweet/'  # Redirect to tweet list after logout