...
SECRET_KEY = 'django-insecure-$hyr3tj6e-anf^7=8+6ld4(c)l4du+pqk%2_ux$us9afe27wa3'
...
INSTALLED_APPS = [
    'shop.apps.ShopConfig',  # Custom app for the shop
    ...
    'django.contrib.staticfiles',
     # Custom app for the e-commerce site
